if global.selected != noone
{
	...
	if global.selected.move_points < global.selected.max_move_points
	{
		impossible_action = true;
	}
	if checking_for_object_next_to and not object_next_to(object_to_check)
	{
		impossible_action = true;
	}
	if global.selected.hit_points == global.selected.max_hit_points
	{
		impossible_action = true;
	}
